...
import { ClassDeclaration, ClassDeclarationStructure, InterfaceDeclaration, InterfaceDeclarationStructure, ParameterDeclarationStructure, SourceFile } from 'ts-simple-ast';
export declare class GraphQLAstExplorer {
    ...
    lookupDefinition(item: TypeSystemDefinitionNode, tsFile: SourceFile, mode: 'class' | 'interface'): void;
    lookupRootSchemaDefinition(operationTypes: OperationTypeDefinitionNode[], tsFile: SourceFile, mode: 'class' | 'interface'): void;
    ...
    getFunctionParameters(inputs: InputValueDefinitionNode[]): ParameterDeclarationStructure[];
